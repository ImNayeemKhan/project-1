...
import { adminAuditLogRouter } from './admin.auditLog.routes';
import { adminFeatureFlagsRouter } from './admin.featureFlags.routes';
import { adminBulkImportRouter } from './admin.bulkImport.routes';
import { adminHealthRouter } from './admin.health.routes';
...
export function buildApiRouter(limiters: RateLimiters) {
  ...
  apiRouter.use('/admin/feature-flags', adminFeatureFlagsRouter);
  apiRouter.use('/admin/bulk-import', adminBulkImportRouter);
  apiRouter.use('/admin/health', adminHealthRouter);
